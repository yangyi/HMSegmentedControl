...
- (void)commonInit {
    ...
    self.selectionIndicatorBoxCornerRadius = 0.0;
    self.selectionIndicatorBoxSize = CGSizeZero;
...
- (CGRect)frameForFillerSelectionIndicator {
    ...
    CGSize sz = self.selectionIndicatorBoxSize;

    CGFloat offsetX = (self.segmentWidth - sz.width) / 2.0;
    CGFloat offsetY = (CGRectGetHeight(self.frame) - sz.height) / 2.0;

    return CGRectMake(self.segmentWidth * self.selectedSegmentIndex + offsetX, offsetY, sz.width, sz.height);
